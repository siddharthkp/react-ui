...
import { Element, Card, Stack, Text, Paragraph, Avatar, Link } from 'react-ui'
...
const Documentation = () => {
  return (
    <Page title="Getting started">
      ...
      <Para>
        React UI comes with <Link href="/components">a set of components</Link>{' '}
        that are <Text weight="medium">accessible</Text>,{' '}
