  ...
  return (
    <Page title="Creating new components">
      ...
      <Section id="using-element" title="1. Using the base element">
        <Para>
          <Text>
            Every component in React UI uses a common base <Code>Element</Code>.
            This is what a component looks in it's simplest form.
          </Text>
        </Para>
        <Example codeFirst>
        ...
        <Para>
          ...
          <Text>
            One of these is the <Code>css</Code> prop that is connected to your
            theme — which means it resolves the values you provide to their
            matching value in the theme.
          </Text>
          <Text>
        ...
        <Para>
          <Text>
            ...
            definition. Margin should be added at the time of using these blocks
            based on the layout and elements around them.
          </Text>
        </Para>
        <Para>
          <Text>
            The other features that <Code>Element</Code> adds is the support for{' '}
            <Code>margin</Code>, <Link href="accepting-props">variant</Link> and{' '}
        ...
        <Para>
          <Text>
            While inline styles should be used sparingly, components built with{' '}
            <Code>Element</Code> connect the <Code>styles</Code> prop with the
            theme as well.
          </Text>
        </Para>
        <Example codeFirst>
        ...
        <Para>
          <Text>
            If you'd like your component to behave like it's part of the library
            and benefit from the customisation API mentioned in the{' '}
            <Link href="/core-concepts/customisation">Customisation docs</Link>,
      ...
      >
        ...
        <Para>
          ...
          <Text>
            If you want to allow the component to receive additional styles via
            the <Code>css</Code> prop, you can use <Code>merge</Code> utility
            from React UI to deeply merge them with the base styles.
          </Text>
        </Para>
        <Example codeFirst>
          <Example.Code lang="js">{`
      ...
      <Section id="accepting-props" title="3. Adapting styles based on props">
        ...
        <Para>
          <Text>
            This kind of customisation is fairly common, so there is first class
            support for this in the theming layer.
          </Text>
        </Para>
        <Example codeFirst>
          <Example.Code lang="js">{`
