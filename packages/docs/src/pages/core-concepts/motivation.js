  ...
  return (
    <Page title="Motivation" tagline="or why does this project exist?">
      ...
      <Section title="Authoring design in Code">
        <Para>
          <Text>
            To be able to carry these concepts in code, we need to work with the
            right abstraction: Components connected to scales
          </Text>
          <Text>
        ...
        <Para>
          <Text>
            Some of the information that describes the apartment is more useful
            than the rest and should have different visual treatment.
          </Text>
        </Para>
        ...
        <Para>
          <Text>
            Notice how the <Code>Stack</Code> uses <i>2 units fom the space</i>{' '}
            scale as the gap between the image and the block of text.
          </Text>
          <Text>
          ...
          <Example.Code>{`
            <Stack
              ...
              css={{
                ...
                border: '1px solid',      
                borderColor: 'grays.300', // theme.colors.grays.300
      ...
      <Section title="Defining the scales">
        ...
        <Para>
          <Link href="/todo">Read more about defining the theme here →</Link>
        </Para>
      </Section>
    </Page>
  )
