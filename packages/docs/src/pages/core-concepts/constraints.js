...
import { Avatar, Card, Stack, Text, Link, Input, Form, Button } from 'react-ui'
      ...
      <Section>
        <Para>
          <Text>
            ...
            every minute. At the core of every high quality interface, is a set
            of constraints that help in creating this level of consistency and
            quality.
          </Text>
          <Text>
        ...
        <Para>
          <Text>Let's take example of a Airbnb clone built with React UI:</Text>
        </Para>
        <Example
          hideCode
          css={{
        ...
        <Para>
          ...
          <Text css={{ paddingLeft: 5 }}>
            The smallest space is between between a label and input field, 1
            unit = 8px. To create the diffrentiation between multiple fields, we
            need more space, bumping to the next unit of 2 = 16px does the job.
          </Text>
        </Para>
        <Example
          hideCode
        ...
        <Para>
          ...
          <Text>
            ...
            <Link href="/core-concepts/customisation">customise the scale</Link>{' '}
        ...
        <Para>
          <Text>
            You can pick font sizes one level apart on the font scale to create
            a distinguish between the primary and secondary information.
          </Text>
        ...
        <Para>
          <Text>
            This concept isn't new, this is the idea behind Design Tokens. Folks
            working on design system like{' '}
