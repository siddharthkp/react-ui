    ...
    <ThemeProvider theme={light.theme} components={light.components}>
      <Page title="Constraints Based Design">
        <Section>
          ...
          <Para>
            <Text>
              There are a lot of decisions that the folks building this UI had
              to make. Let's look at just one of these:{' '}
              <i>Space between elements.</i>
            </Text>
          </Para>
          <Para>
            <Text>
              There are two kinds of decisions that are worth noticing:
            </Text>
          </Para>
          <Para>
            <Text>
          ...
          <Para>
            <Text>
              The idea of picking values only from a scale might feel
              restrictive at first, but very soon, it starts freeing you up to
              focus on the more important details. Try it before you dismiss it.
            </Text>
            <Text>
