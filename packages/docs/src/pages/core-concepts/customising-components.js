    ...
    <Page title="Customising components">
      <Para>
        <Text variant="subtle" css={{ fontStyle: 'italic' }}>
          This page talks about customising the look and feel of Components. If
          you want to customise design tokens like colors, space, font sizes,
          etc. at the application level, jump to{' '}
      ...
      <Section>
        ...
        >
          <Para as="li">
            <Text>
              <Link href="#re-export-components">1. Re-export components</Link>
            </Text>
            <Text css={{ paddingLeft: 4 }}>
              ...
              , pick this. This option is great for products with one aesthetic
              and/or for folks building internal component libraries for their
              teams.
            </Text>
          </Para>
          <Para as="li">
            ...
            <Text css={{ paddingLeft: 4 }}>
              This approach is recommended if you are using React UI to build a{' '}
              <Text css={{ textDecoration: 'underline' }}>
        ...
        <Para>
          <Text>
            You can achieve the same results with either option, so you can also
            make also the choice based on the API you like more.
          </Text>
        </Para>
      </Section>
      ...
      <Section id="re-export-components" title="1. Re-export components">
        ...
        <Para>
          ...
          <Text>
            ...
            <Link href="/components/Breadcrumb#Customisation">Breadcrumb:</Link>
          </Text>
          <Example hideCode>
      ...
      <Section id="components-in-theme" title="2. Components in theme">
        ...
        <Para>
          <Text>
            Along with theme, you can pass a second <Code>components</Code> prop
            to the <Code>ThemeProvider</Code> to modify{' '}
            <Text css={{ textDecoration: 'underline' }}>
        ...
        <Para>
          <Text>
            ...
            <Code>components</Code> object to a file of it's own or add them to
            the theme file.
          </Text>
        </Para>
        <Para>
